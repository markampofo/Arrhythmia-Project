...
gamma = 0.001;%original % can be 0 or negative
%gamma = 0.005;
%gamma = 0.008;
%gamma = 0.01;
% orig
...
elseif parameterflag == 1 %steep parameters
    parametersetname = 'Steep Restitution Curve';% voltage driven alternans
%    tau0 = 30; A1 = 0; D1 = 60; tau1 = 500;
...
%A0 = 220; D0 = 40; tau0 = 60; A1 = 60; D1 = 60; tau1 = 500; 
    tau0 = 60;
    A1 = 60;
elseif parameterflag == 4
    parametersetname = ('Shallow Restitution, Ca-induced');
%A0 = 220; D0 = 40; tau0 = 60; A1 = 0; D1 = 60; tau1 = 500; % shallower
    tau0 = 60;
    nu=0.4;
...
%        [V, D]              = eig(jac);
        ...
        K2  = [B2 jac*B2 jac^2*B2 jac^3*B2];
        K3  = [B3 jac*B3 jac^2*B3 jac^3*B3];
        K4  = [B4 jac*B4 jac^2*B4 jac^3*B4];
        K5  = [B5 jac*B5 jac^2*B5 jac^3*B5];
