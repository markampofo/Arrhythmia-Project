...
%% functions for single and multi variable state feedback 
nsteps = 100;
x0 = [0.1 0.1 0.1 0.1]';%Initial value

%functions for single variable state feedback 
Ksc = 2.10; %gain for single variable state feedback
...
%functions for multi variable state feedback (Pole Placement) 
...
xsv(:,1)  = x0;
Ksv = [0 -Ksc 0 0]; %The position of -Ksc depends on where control is being applied hence can change
