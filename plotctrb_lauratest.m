% Laura: I was getting confused about whether the OL eigenvalues were
% consistent with those in the Ca-driven case plots in the presentation. I
% made this file to check values. 
